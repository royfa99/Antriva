...
export default function PatientDashboard() {
  ...
  const handleDeletePatient = async (id: string) => {
    ...
    try {
      await (async (...args) => { const r = await deletePatient(...args); if (r && typeof r === "object" && "error" in r && typeof (r as any).error === "string") throw new Error((r as any).error); return r; })(id);
  ...
  const handleTakeQueue = async (e: React.FormEvent) => {
    ...
    try {
      await (async (...args) => { const r = await takeQueue(...args); if (r && typeof r === "object" && "error" in r && typeof (r as any).error === "string") throw new Error((r as any).error); return r; })(selectedScheduleId, selectedDate, selectedPatientId);
  ...
  const handleCancelQueue = async (queueId: string) => {
    ...
    setActionLoading(true);
    try {
      await (async (...args) => { const r = await cancelQueue(...args); if (r && typeof r === "object" && "error" in r && typeof (r as any).error === "string") throw new Error((r as any).error); return r; })(queueId);
      await fetchData();
    } catch (e: any) {
